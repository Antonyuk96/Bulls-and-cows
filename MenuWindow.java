...
public class MenuWindow {
	...
	MenuWindow(BullsAndCowsController controller){
		...
		String tooltipPlay="Нажмите чтобы начать игру";
		String tooltipRules="Правила игры";
		String tooltipExit ="Выйти из игры?"; 
		String tooltipContinue="Продолжить последнюю игру?";
		primaryStage = new Stage();
		primaryStage.setTitle("Быки и коровы");
		
		root = new AnchorPane();
		root.setId("Главное окно");
		
		buttonPlay = createButton(titlePlay, tooltipPlay, primaryStage);
		buttonPlay.setId("Кнопка "Играть"");
	...
	public Boolean showDialogForGame() throws IOException {
		...
		dialog.setHeaderText("Текст про коров");
		dialog.setContentText("Введите число:");
	...
	public void showReplayDialog() {
		...
		dialog.setHeaderText("Сыграть заново:\n"+controller.getAllFiles());
		dialog.setContentText("Введите имя файла для переигровки:");
